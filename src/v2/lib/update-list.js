function generateExportUrl(sheet) {
  ...
  return new ExportService(sheet).getExportUrl(newItems);
}
...
function test_updateList() {
  updateList(SpreadsheetApp.openById('1qHNK8IxARCedG5cLeUYbSXjzEBfBzpkoX0mopH0OdNQ').getSheetByName('Détail Visa Plan VDC'))
}
